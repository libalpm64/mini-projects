...
static volatile void codevault_Decoy() {
    WATERMARK("codevault - [ Secured Memory Region ]", // Message for crackers ;)
        "codevault - [ Overwritten Memory Region Bytes ]", 0);
}

// Fake decoy functions to hide the original one (for call hiding)
static void obfusheader_decoy_1() { codevault_Decoy(); }
static void obfusheader_decoy_2() { codevault_Decoy(); }
static void obfusheader_decoy_3() { codevault_Decoy(); }
static void obfusheader_decoy_4() { codevault_Decoy(); }
static void obfusheader_decoy_5() { codevault_Decoy(); }
static void obfusheader_decoy_6() { codevault_Decoy(); }
static void obfusheader_decoy_7() { codevault_Decoy(); }
static void obfusheader_decoy_8() { codevault_Decoy(); }
static void obfusheader_decoy_9() { codevault_Decoy(); }
static void obfusheader_decoy_10() { codevault_Decoy(); }
