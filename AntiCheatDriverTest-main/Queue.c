...
Abstract:
   ...
   - The driver queuing system block used in the windows kernel (WFQI).

Environment:

    - Anticheat Kernel Level Driver QIFO
...
#define WPP_CONTROL_GUIDS \
    WPP_DEFINE_CONTROL_GUID(QueueGuid,(82881111,1222,3333,4444,555555555555), \
...
// Define TraceEvents macro
#define TraceEvents(level, flags, msg, ...) \
    DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_INFO_LEVEL, msg, __VA_ARGS__)
